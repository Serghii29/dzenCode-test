  ...
  switch (specification) {
    case Specification.Specification_1:
      filterProducts = filterProducts
        .filter(product => product.specification === 'Specification 1');
      break;

    case Specification.Specification_2:
      filterProducts = filterProducts
        .filter(product => product.specification === 'Specification 2');
      break;

    case Specification.Specification_3:
      filterProducts = filterProducts
        .filter(product => product.specification === 'Specification3');
      break;
